        ...
        <main class="wl-main">
            ...
            <div class="wl-fade-up-2" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1px; background: var(--border); border: 1px solid var(--border); border-radius: var(--radius-md); overflow: hidden; margin-bottom: 1.5rem;">
                <div style="background: var(--bg-card); padding: 1rem 1.5rem; display: flex; flex-direction: column; gap: 0.25rem;">
                    <div style="font-size: 1.5rem; font-weight: 800; font-family: var(--font-display); color: var(--accent); line-height: 1;"><?= isset($total_kendaraan) ? number_format($total_kendaraan) : 0 ?></div>
                    <div style="font-size: 0.75rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; color: var(--text-muted);">Total Kendaraan</div>
                </div>
                <div style="background: var(--bg-card); padding: 1rem 1.5rem; display: flex; flex-direction: column; gap: 0.25rem;">
                    <div style="font-size: 1.5rem; font-weight: 800; font-family: var(--font-display); color: #10b981; line-height: 1;"><?= isset($categories_count) ? number_format($categories_count) : 0 ?></div>
                    <div style="font-size: 0.75rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; color: var(--text-muted);">Kategori Tersedia</div>
                </div>
            </div>
