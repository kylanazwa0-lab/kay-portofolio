...
<head>
    ...
    <title>Import Data Transaksi - Wuling System</title>
        ...
        <main class="wl-main">
            <div class="import-wrapper wl-fade-up-2">
                ...
                <div class="import-breadcrumb">
                    <a href="<?= site_url('report'); ?>">Laporan</a>
                ...
                <div class="import-header">
                    <div class="import-title-wrap">
                        <h1>
                            ...
                            <span class="import-badge">EXCEL</span>
                        </h1>
                        <p>Upload file Excel → Proses otomatis → Data masuk ke database</p>
                    </div>
                    <div class="import-header-actions">
                        <a href="<?= site_url('report'); ?>" class="wl-btn wl-btn-secondary wl-btn-sm">
                            <i class="fas fa-arrow-left"></i> Kembali
                        </a>
                        <a href="<?= site_url('report/download_template'); ?>" class="wl-btn wl-btn-secondary wl-btn-sm">
                ...
                <!-- Drop Zone Card -->
                <form action="<?= site_url('report/import_excel'); ?>" method="post" enctype="multipart/form-data" id="importForm">
                    <div class="drop-zone-card">
                        ...
                        <div class="drop-zone-footer">
                            ...
                            <div style="font-size: 0.78rem; color: var(--text-muted);">
                                ...
                                Kolom: Tanggal, Customer, Sales, Model, Tipe, Tunai/Kredit, Harga List, Diskon, Harga Net, DP, Leasing, Status
                            </div>
                        </div>
